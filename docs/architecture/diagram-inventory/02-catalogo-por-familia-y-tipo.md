...
| `DIA-REQ-CU-GRP-AUT..SAL` | Casos de uso por seis grupos propietarios | `domain-and-use-cases/03-casos-de-uso-vigentes.md` | 6 | Los reportes se integran con el grupo del recurso que los inicia; curado. |
