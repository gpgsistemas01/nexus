...
| ¿Qué decisión local no resulta evidente al leer una función? | Comentario próximo al código o JSDoc, de acuerdo con el [estándar de codificación](../coding-standards/10-comments-and-documentation.md). | Enlazar una vista estable sólo si aporta contexto; no insertar Mermaid en archivos JavaScript. |
