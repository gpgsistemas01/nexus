...
- contexto, contenedores, despliegue, componentes y recorrido general en
  [arquitectura y vistas web](../architecture-and-web-views/02-arquitectura-del-sistema.md);
- superficie HTTP, colaboración de dominios, petición real y reutilización CRUD en
  [diagramas del código](../code-diagrams/02-patron-de-organizacion-de-las-vistas.md);
