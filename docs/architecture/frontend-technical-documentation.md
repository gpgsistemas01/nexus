...
| `CU-CAT-21` | La pantalla de Áreas carga su tabla. | `getAllCatalogEntries` consume `GET /api/admin/catalogs/departments`. | [`DIA-FE-CU-CAT-21`](frontend-code-sequences/catalogs.md#cu-cat-21) |
| `CU-CAT-22` | El modal abre el alta de Áreas. | `registerCatalogEntry` consume `POST /api/admin/catalogs/departments`. | [`DIA-FE-CU-CAT-22`](frontend-code-sequences/catalogs.md#cu-cat-22) |
| `CU-CAT-23` | La acción de fila abre la edición de Áreas. | `editCatalogEntry` consume `PUT /api/admin/catalogs/departments/:id`. | [`DIA-FE-CU-CAT-23`](frontend-code-sequences/catalogs.md#cu-cat-23) |
| `CU-CAT-24` | La pantalla de Roles carga su tabla. | `getAllCatalogEntries` consume `GET /api/admin/catalogs/roles`. | [`DIA-FE-CU-CAT-24`](frontend-code-sequences/catalogs.md#cu-cat-24) |
| `CU-CAT-25` | El modal abre el alta de Roles. | `registerCatalogEntry` consume `POST /api/admin/catalogs/roles`. | [`DIA-FE-CU-CAT-25`](frontend-code-sequences/catalogs.md#cu-cat-25) |
| `CU-CAT-26` | La acción de fila abre la edición de Roles. | `editCatalogEntry` consume `PUT /api/admin/catalogs/roles/:id`. | [`DIA-FE-CU-CAT-26`](frontend-code-sequences/catalogs.md#cu-cat-26) |
| `CU-CAT-27` | La pantalla de Presentaciones carga su tabla. | `getAllCatalogEntries` consume `GET /api/admin/catalogs/presentations`. | [`DIA-FE-CU-CAT-27`](frontend-code-sequences/catalogs.md#cu-cat-27) |
| `CU-CAT-28` | El modal abre el alta de Presentaciones. | `registerCatalogEntry` consume `POST /api/admin/catalogs/presentations`. | [`DIA-FE-CU-CAT-28`](frontend-code-sequences/catalogs.md#cu-cat-28) |
| `CU-CAT-29` | La acción de fila abre la edición de Presentaciones. | `editCatalogEntry` consume `PUT /api/admin/catalogs/presentations/:id`. | [`DIA-FE-CU-CAT-29`](frontend-code-sequences/catalogs.md#cu-cat-29) |
| `CU-CAT-30` | La pantalla de Unidades de medida carga su tabla. | `getAllCatalogEntries` consume `GET /api/admin/catalogs/unit-measures`. | [`DIA-FE-CU-CAT-30`](frontend-code-sequences/catalogs.md#cu-cat-30) |
| `CU-CAT-31` | El modal abre el alta de Unidades de medida. | `registerCatalogEntry` consume `POST /api/admin/catalogs/unit-measures`. | [`DIA-FE-CU-CAT-31`](frontend-code-sequences/catalogs.md#cu-cat-31) |
| `CU-CAT-32` | La acción de fila abre la edición de Unidades de medida. | `editCatalogEntry` consume `PUT /api/admin/catalogs/unit-measures/:id`. | [`DIA-FE-CU-CAT-32`](frontend-code-sequences/catalogs.md#cu-cat-32) |
| `CU-CAT-33` | La pantalla de Motivos de ajuste carga su tabla. | `getAllCatalogEntries` consume `GET /api/admin/catalogs/reasons`. | [`DIA-FE-CU-CAT-33`](frontend-code-sequences/catalogs.md#cu-cat-33) |
| `CU-CAT-34` | El modal abre el alta de Motivos de ajuste. | `registerCatalogEntry` consume `POST /api/admin/catalogs/reasons`. | [`DIA-FE-CU-CAT-34`](frontend-code-sequences/catalogs.md#cu-cat-34) |
| `CU-CAT-35` | La acción de fila abre la edición de Motivos de ajuste. | `editCatalogEntry` consume `PUT /api/admin/catalogs/reasons/:id`. | [`DIA-FE-CU-CAT-35`](frontend-code-sequences/catalogs.md#cu-cat-35) |
| `CU-CAT-36` | La pantalla de Estados de cumplimiento carga su tabla. | `getAllCatalogEntries` consume `GET /api/admin/catalogs/fulfillment-statuses`. | [`DIA-FE-CU-CAT-36`](frontend-code-sequences/catalogs.md#cu-cat-36) |
| `CU-CAT-37` | El modal abre el alta de Estados de cumplimiento. | `registerCatalogEntry` consume `POST /api/admin/catalogs/fulfillment-statuses`. | [`DIA-FE-CU-CAT-37`](frontend-code-sequences/catalogs.md#cu-cat-37) |
| `CU-CAT-38` | La acción de fila abre la edición de Estados de cumplimiento. | `editCatalogEntry` consume `PUT /api/admin/catalogs/fulfillment-statuses/:id`. | [`DIA-FE-CU-CAT-38`](frontend-code-sequences/catalogs.md#cu-cat-38) |
...
| `CU-REP-03` | Botón Excel de `materialDatatable.js` abre `showInventoryExportDialog`. | `buildExcelButton` propaga `inventoryScope`; `exportWarehouseReport` → `exportWarehouseReportRequest` descarga `/api/warehouse/reports/inventory/excel`. | [`DIA-FE-CU-REP-03`](frontend-code-sequences/reports.md#cu-rep-03) |
...
| `CU-REP-09` | Botón Excel de `wasteDatatable.js` abre `showInventoryExportDialog`. | `buildExcelButton` propaga `inventoryScope`; `exportWasteReport` → request homólogo descarga `/api/warehouse/reports/wastes/excel`. | [`DIA-FE-CU-REP-09`](frontend-code-sequences/reports.md#cu-rep-09) |
