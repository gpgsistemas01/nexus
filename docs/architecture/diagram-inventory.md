...
| `DIA-BE-TEC-EST-AUT-01`, `DIA-BE-TEC-EST-CU-ENT-04`, `DIA-FE-TEC-EST-CU-IDA-07`, `DIA-FE-TEC-EST-CU-CAT-05` | Estados técnicos complementarios | Secciones técnicas del caso correspondiente | 4 | Elegibilidad de acceso y transacción backend, más modos de formulario frontend; no duplican estados normativos. |
