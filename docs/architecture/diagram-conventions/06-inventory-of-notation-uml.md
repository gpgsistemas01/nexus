...
[catálogo visual de patrones aplicados](../design-and-construction-patterns/04-catalog-visual-of-patterns-applied.md#4-catálogo-visual-de-patrones-aplicados),
