...
| `CU-IDA-04` | `GET /api/admin/users` → `getAllUsers`. | `userService.findAllUsers` consulta cuentas y accesos. | [`DIA-BE-CU-IDA-04`](backend-code-sequences/identity-access.md#cu-ida-04) |
| `CU-IDA-05` | `POST /api/admin/users` → `registerUser`. | `userService.createUser` crea cuenta, contraseña cifrada y acceso. | [`DIA-BE-CU-IDA-05`](backend-code-sequences/identity-access.md#cu-ida-05) |
| `CU-IDA-06` | `PATCH /api/admin/users/:id` → `editUser`. | `userService.updateUser` actualiza cuenta y asignación autorizada. | [`DIA-BE-CU-IDA-06`](backend-code-sequences/identity-access.md#cu-ida-06) |
| `CU-IDA-07` | `PATCH /api/admin/users/:id/password` → `editUserPassword`. | `userService.updateUserPassword` cifra y sustituye la contraseña. | [`DIA-BE-CU-IDA-07`](backend-code-sequences/identity-access.md#cu-ida-07) |
| `CU-IDA-08` | `GET /api/admin/roles` → `roleController.getAllRoles`. | `roleService.findAllRoles` lee `Role`; no existe mutación publicada. | [`DIA-BE-CU-IDA-08`](backend-code-sequences/identity-access.md#cu-ida-08) |
| `CU-IDA-09` | `GET /api/admin/departments` → `departmentController.getAllDepartments`. | `departmentService.findAllDepartments` lee `Department`. | [`DIA-BE-CU-IDA-09`](backend-code-sequences/identity-access.md#cu-ida-09) |
...
| `CU-CAT-06` | `GET /api/warehouse/suppliers` → `getAllSuppliers`. | `supplierService.findAllSuppliers` consulta proveedores. | [`DIA-BE-CU-CAT-06`](backend-code-sequences/catalogs.md#cu-cat-06) |
| `CU-CAT-07` | `POST /api/warehouse/suppliers` → `registerSupplier`. | `supplierService.createSupplier` persiste el proveedor. | [`DIA-BE-CU-CAT-07`](backend-code-sequences/catalogs.md#cu-cat-07) |
| `CU-CAT-08` | `PUT /api/warehouse/suppliers/:id` → `editSupplier`. | `supplierService.updateSupplier` actualiza datos del proveedor. | [`DIA-BE-CU-CAT-08`](backend-code-sequences/catalogs.md#cu-cat-08) |
| `CU-CAT-09` | `PUT /api/warehouse/suppliers/:id` → `editSupplier`. | `supplierService.updateSupplier` aplica el estado incluido en el DTO; no hay endpoint separado. | [`DIA-BE-CU-CAT-09`](backend-code-sequences/catalogs.md#cu-cat-09) |
| `CU-CAT-10` | `GET /api/sales/clients` → `getAllClients`. | `clientService.findAllClients` consulta `Client`. | [`DIA-BE-CU-CAT-10`](backend-code-sequences/catalogs.md#cu-cat-10) |
| `CU-CAT-11` | `POST /api/sales/clients` → `registerClient`. | `clientService.createClient` persiste `Client`. | [`DIA-BE-CU-CAT-11`](backend-code-sequences/catalogs.md#cu-cat-11) |
| `CU-CAT-12` | `PUT /api/sales/clients/:id` → `editClient`. | `clientService.updateClient` actualiza `Client`. | [`DIA-BE-CU-CAT-12`](backend-code-sequences/catalogs.md#cu-cat-12) |
| `CU-CAT-13` | `GET /api/warehouse/wastes` → `getAllWastes`. | `wasteService.findAllWastes` consulta merma e inventario. | [`DIA-BE-CU-CAT-13`](backend-code-sequences/catalogs.md#cu-cat-13) |
| `CU-CAT-14` | `GET /api/warehouse/wastes/material-templates` y `POST /api/warehouse/wastes` → `getWasteMaterialTemplates`/`registerWaste`. | `findWasteMaterialTemplates` alimenta la selección y `createWasteWithInitialStockAdjustment` crea merma, ajuste y movimiento inicial. | [`DIA-BE-CU-CAT-14`](backend-code-sequences/catalogs.md#cu-cat-14) |
| `CU-CAT-15` | `PATCH /api/warehouse/wastes/:id` → `editWaste`. | `wasteService.updateWaste` actualiza datos sin tratar stock como edición. | [`DIA-BE-CU-CAT-15`](backend-code-sequences/catalogs.md#cu-cat-15) |
| `CU-CAT-16` | `PATCH /api/warehouse/wastes/:id/stock` → `editWasteStock`. | `wasteService.updateWasteStock` y `registerWasteStockAdjustment` aplican ajuste/movimiento. | [`DIA-BE-CU-CAT-16`](backend-code-sequences/catalogs.md#cu-cat-16) |
| `CU-CAT-17` | `GET /api/warehouse/presentations` → `getAllPresentations`. | `presentationService.findAllPresentations` sirve el catálogo de sólo lectura. | [`DIA-BE-CU-CAT-17`](backend-code-sequences/catalogs.md#cu-cat-17) |
| `CU-CAT-18` | `GET /api/warehouse/unit-measures` → `getAllUnitMeasures`. | `unitMeasureService.findAllUnitMeasures` sirve el catálogo de sólo lectura. | [`DIA-BE-CU-CAT-18`](backend-code-sequences/catalogs.md#cu-cat-18) |
| `CU-CAT-19` | `GET /api/warehouse/reasons` → `getAllReasons`. | `reasonService.findAllReasons` sirve motivos; helpers resuelven motivos internos. | [`DIA-BE-CU-CAT-19`](backend-code-sequences/catalogs.md#cu-cat-19) |
| `CU-CAT-20` | `GET /api/warehouse/fulfillment-statuses` → `getAllFulfillmentStatuses`. | `fulfillmentStatusService.findAllFulfillmentStatuses` sirve estados de sólo lectura. | [`DIA-BE-CU-CAT-20`](backend-code-sequences/catalogs.md#cu-cat-20) |
| `CU-CAT-21` | `GET /api/admin/catalogs/departments` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Áreas. | [`DIA-BE-CU-CAT-21`](backend-code-sequences/catalogs.md#cu-cat-21) |
| `CU-CAT-22` | `POST /api/admin/catalogs/departments` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Áreas. | [`DIA-BE-CU-CAT-22`](backend-code-sequences/catalogs.md#cu-cat-22) |
| `CU-CAT-23` | `PUT /api/admin/catalogs/departments/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Áreas. | [`DIA-BE-CU-CAT-23`](backend-code-sequences/catalogs.md#cu-cat-23) |
| `CU-CAT-24` | `GET /api/admin/catalogs/roles` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Roles. | [`DIA-BE-CU-CAT-24`](backend-code-sequences/catalogs.md#cu-cat-24) |
| `CU-CAT-25` | `POST /api/admin/catalogs/roles` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Roles. | [`DIA-BE-CU-CAT-25`](backend-code-sequences/catalogs.md#cu-cat-25) |
| `CU-CAT-26` | `PUT /api/admin/catalogs/roles/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Roles. | [`DIA-BE-CU-CAT-26`](backend-code-sequences/catalogs.md#cu-cat-26) |
| `CU-CAT-27` | `GET /api/admin/catalogs/presentations` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Presentaciones. | [`DIA-BE-CU-CAT-27`](backend-code-sequences/catalogs.md#cu-cat-27) |
| `CU-CAT-28` | `POST /api/admin/catalogs/presentations` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Presentaciones. | [`DIA-BE-CU-CAT-28`](backend-code-sequences/catalogs.md#cu-cat-28) |
| `CU-CAT-29` | `PUT /api/admin/catalogs/presentations/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Presentaciones. | [`DIA-BE-CU-CAT-29`](backend-code-sequences/catalogs.md#cu-cat-29) |
| `CU-CAT-30` | `GET /api/admin/catalogs/unit-measures` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Unidades de medida. | [`DIA-BE-CU-CAT-30`](backend-code-sequences/catalogs.md#cu-cat-30) |
| `CU-CAT-31` | `POST /api/admin/catalogs/unit-measures` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Unidades de medida. | [`DIA-BE-CU-CAT-31`](backend-code-sequences/catalogs.md#cu-cat-31) |
| `CU-CAT-32` | `PUT /api/admin/catalogs/unit-measures/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Unidades de medida. | [`DIA-BE-CU-CAT-32`](backend-code-sequences/catalogs.md#cu-cat-32) |
| `CU-CAT-33` | `GET /api/admin/catalogs/reasons` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Motivos de ajuste. | [`DIA-BE-CU-CAT-33`](backend-code-sequences/catalogs.md#cu-cat-33) |
| `CU-CAT-34` | `POST /api/admin/catalogs/reasons` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Motivos de ajuste. | [`DIA-BE-CU-CAT-34`](backend-code-sequences/catalogs.md#cu-cat-34) |
| `CU-CAT-35` | `PUT /api/admin/catalogs/reasons/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Motivos de ajuste. | [`DIA-BE-CU-CAT-35`](backend-code-sequences/catalogs.md#cu-cat-35) |
| `CU-CAT-36` | `GET /api/admin/catalogs/fulfillment-statuses` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Estados de cumplimiento. | [`DIA-BE-CU-CAT-36`](backend-code-sequences/catalogs.md#cu-cat-36) |
| `CU-CAT-37` | `POST /api/admin/catalogs/fulfillment-statuses` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Estados de cumplimiento. | [`DIA-BE-CU-CAT-37`](backend-code-sequences/catalogs.md#cu-cat-37) |
| `CU-CAT-38` | `PUT /api/admin/catalogs/fulfillment-statuses/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Estados de cumplimiento. | [`DIA-BE-CU-CAT-38`](backend-code-sequences/catalogs.md#cu-cat-38) |
...
| `CU-SAL-07` | `GET /api/warehouse/waste-issues` → `getAllWasteIssues`. | `wasteIssueService.findAllWasteIssues` consulta salidas de merma. | [`DIA-BE-CU-SAL-07`](backend-code-sequences/issues.md#cu-sal-07) |
| `CU-SAL-08` | `POST /api/warehouse/waste-issues` → `registerWasteIssue`. | `wasteIssueService.createWasteIssue` crea encabezado y detalles de merma. | [`DIA-BE-CU-SAL-08`](backend-code-sequences/issues.md#cu-sal-08) |
| `CU-SAL-09` | `PATCH /api/warehouse/waste-issues/:id/header` → `editWasteIssueHeader`. | `wasteIssueService.updateWasteIssueHeader` aplica reglas del encabezado. | [`DIA-BE-CU-SAL-09`](backend-code-sequences/issues.md#cu-sal-09) |
| `CU-SAL-10` | `PATCH /api/warehouse/waste-issues/:id/details` → `editWasteIssueDetails`. | `wasteIssueService.updateWasteIssueDetails` modifica cantidades editables. | [`DIA-BE-CU-SAL-10`](backend-code-sequences/issues.md#cu-sal-10) |
| `CU-SAL-11` | `PATCH /api/warehouse/waste-issues/:id/details` → `editWasteIssueDetails`. | `updateWasteIssueDetails` llama `applyWasteIssueMovement` y recalcula cumplimiento con `tx`. | [`DIA-BE-CU-SAL-11`](backend-code-sequences/issues.md#cu-sal-11) |
| `CU-SAL-12` | `PATCH /api/warehouse/waste-issues/:id/details/:detailId/returns` → `registerWasteIssueDetailReturn`. | `returnWasteIssueDetail` crea `WasteIssueReturn`, movimiento inverso y estados en transacción. | [`DIA-BE-CU-SAL-12`](backend-code-sequences/issues.md#cu-sal-12) |
| `CU-REP-01` | `GET /api/warehouse/materials` → `getAllMaterials`. | Reutiliza `findAllMaterials` con filtros; sólo lectura. | [`DIA-BE-CU-REP-01`](backend-code-sequences/reports.md#cu-rep-01) |
| `CU-REP-02` | `GET /api/admin/movements/materials` → `getAllMaterialMovements`. | `movementQueryService.findAllMaterialMovements`; sólo lectura. | [`DIA-BE-CU-REP-02`](backend-code-sequences/reports.md#cu-rep-02) |
| `CU-REP-03` | `GET /api/warehouse/reports/inventory/excel` → `exportWarehouseReportExcel`. | `reportService.findWarehouseReportRows` aplica `inventoryScope` y `sendExcelReport`. | [`DIA-BE-CU-REP-03`](backend-code-sequences/reports.md#cu-rep-03) |
| `CU-REP-04` | `GET /api/warehouse/reports/goods-issues/excel` → `exportGoodsIssueReportExcel`. | `reportService.findGoodsIssueReportRows` y `sendExcelReport`. | [`DIA-BE-CU-REP-04`](backend-code-sequences/reports.md#cu-rep-04) |
| `CU-REP-05` | `GET /api/admin/reports/movements/materials/excel` → `exportMovementReport`. | `inventory/reportService.findMovementReportRows` y respuesta Excel. | [`DIA-BE-CU-REP-05`](backend-code-sequences/reports.md#cu-rep-05) |
| `CU-REP-06` | `GET /api/warehouse/wastes` → `getAllWastes`. | Reutiliza `wasteService.findAllWastes` con filtros; sólo lectura. | [`DIA-BE-CU-REP-06`](backend-code-sequences/reports.md#cu-rep-06) |
| `CU-REP-07` | `GET /api/admin/movements/wastes` → `getAllWasteMovements`. | `movementQueryService.findAllWasteMovements`; sólo lectura. | [`DIA-BE-CU-REP-07`](backend-code-sequences/reports.md#cu-rep-07) |
| `CU-REP-08` | `GET /api/warehouse/reports/waste-issues/excel` → `exportWasteIssueReportExcel`. | `reportService.findWasteIssueReportRows` y `sendExcelReport`. | [`DIA-BE-CU-REP-08`](backend-code-sequences/reports.md#cu-rep-08) |
| `CU-REP-09` | `GET /api/warehouse/reports/wastes/excel` → `exportWasteReportExcel`. | `reportService.findWasteReportRows` aplica `inventoryScope` y `sendExcelReport`. | [`DIA-BE-CU-REP-09`](backend-code-sequences/reports.md#cu-rep-09) |
| `CU-REP-10` | `GET /api/admin/reports/movements/wastes/excel` → `exportWasteMovementReport`. | `inventory/reportService.findMovementReportRows` en contexto merma y respuesta Excel. | [`DIA-BE-CU-REP-10`](backend-code-sequences/reports.md#cu-rep-10) |
| `CU-REP-11` | `GET /api/warehouse/reports/goods-receipts/excel` → `exportGoodsReceiptReportExcel`. | `reportService.findGoodsReceiptReportRows` y `sendExcelReport`. | [`DIA-BE-CU-REP-11`](backend-code-sequences/reports.md#cu-rep-11) |
| `CU-REP-12` | `GET /api/warehouse/reports/suppliers/excel` → `exportSupplierReportExcel`. | `reportService.findSupplierReportRows` y `sendExcelReport`. | [`DIA-BE-CU-REP-12`](backend-code-sequences/reports.md#cu-rep-12) |
| `CU-REP-13` | `GET /api/sales/reports/clients/excel` → `exportClientReport`. | `clientService.findAllClients` prepara filas y el controller llama `sendExcelReport`. | [`DIA-BE-CU-REP-13`](backend-code-sequences/reports.md#cu-rep-13) |
| `CU-REP-14` | `GET /api/admin/reports/persons/excel` → `exportPersonReport`. | `personService.findAllPersons` prepara filas y el controller llama `sendExcelReport`. | [`DIA-BE-CU-REP-14`](backend-code-sequences/reports.md#cu-rep-14) |
| `CU-REP-15` | `GET /api/admin/reports/users/excel` → `exportUserReport`. | `userService.findAllUsers` prepara filas y el controller llama `sendExcelReport`. | [`DIA-BE-CU-REP-15`](backend-code-sequences/reports.md#cu-rep-15) |
