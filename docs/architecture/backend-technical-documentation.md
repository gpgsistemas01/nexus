...
| `CU-IDA-10` | `GET /api/admin/roles` → `roleController.getAllRoles`. | `roleService.findAllRoles` lee `Role`; no existe mutación publicada. | [`DIA-BE-CU-IDA-10`](backend-code-sequences/identity-access/cu-ida-10.md#cu-ida-10) |
| `CU-IDA-11` | `GET /api/admin/departments` → `departmentController.getAllDepartments`. | `departmentService.findAllDepartments` lee `Department`. | [`DIA-BE-CU-IDA-11`](backend-code-sequences/identity-access/cu-ida-11.md#cu-ida-11) |
...
| `CU-CAT-06` | `GET /api/warehouse/materials` → `getAllMaterials`. | Reutiliza `findAllMaterials` con filtros; sólo lectura. | [`DIA-BE-CU-CAT-06`](backend-code-sequences/catalogs/cu-cat-06.md#cu-cat-06) |
| `CU-CAT-07` | `GET /api/warehouse/reports/inventory/excel` → `exportWarehouseReportExcel`. | `reportService.findWarehouseReportRows` aplica `inventoryScope` y `sendExcelReport`. | [`DIA-BE-CU-CAT-07`](backend-code-sequences/catalogs/cu-cat-07.md#cu-cat-07) |
| `CU-CAT-08` | `GET /api/admin/movements/materials` → `getAllMaterialMovements`. | `movementQueryService.findAllMaterialMovements`; sólo lectura. | [`DIA-BE-CU-CAT-08`](backend-code-sequences/catalogs/cu-cat-08.md#cu-cat-08) |
| `CU-CAT-09` | `GET /api/admin/reports/movements/materials/excel` → `exportMovementReport`. | `inventory/reportService.findMovementReportRows` y respuesta Excel. | [`DIA-BE-CU-CAT-09`](backend-code-sequences/catalogs/cu-cat-09.md#cu-cat-09) |
| `CU-CAT-10` | `GET /api/warehouse/suppliers` → `getAllSuppliers`. | `supplierService.findAllSuppliers` consulta proveedores. | [`DIA-BE-CU-CAT-10`](backend-code-sequences/catalogs/cu-cat-10.md#cu-cat-10) |
| `CU-CAT-11` | `POST /api/warehouse/suppliers` → `registerSupplier`. | `supplierService.createSupplier` persiste el proveedor. | [`DIA-BE-CU-CAT-11`](backend-code-sequences/catalogs/cu-cat-11.md#cu-cat-11) |
| `CU-CAT-12` | `PUT /api/warehouse/suppliers/:id` → `editSupplier`. | `supplierService.updateSupplier` actualiza datos del proveedor. | [`DIA-BE-CU-CAT-12`](backend-code-sequences/catalogs/cu-cat-12.md#cu-cat-12) |
| `CU-CAT-13` | `PUT /api/warehouse/suppliers/:id` → `editSupplier`. | `supplierService.updateSupplier` aplica el estado incluido en el DTO; no hay endpoint separado. | [`DIA-BE-CU-CAT-13`](backend-code-sequences/catalogs/cu-cat-13.md#cu-cat-13) |
| `CU-CAT-14` | `GET /api/warehouse/reports/suppliers/excel` → `exportSupplierReportExcel`. | `reportService.findSupplierReportRows` y `sendExcelReport`. | [`DIA-BE-CU-CAT-14`](backend-code-sequences/catalogs/cu-cat-14.md#cu-cat-14) |
| `CU-CAT-15` | `GET /api/sales/clients` → `getAllClients`. | `clientService.findAllClients` consulta `Client`. | [`DIA-BE-CU-CAT-15`](backend-code-sequences/catalogs/cu-cat-15.md#cu-cat-15) |
| `CU-CAT-16` | `POST /api/sales/clients` → `registerClient`. | `clientService.createClient` persiste `Client`. | [`DIA-BE-CU-CAT-16`](backend-code-sequences/catalogs/cu-cat-16.md#cu-cat-16) |
| `CU-CAT-17` | `PUT /api/sales/clients/:id` → `editClient`. | `clientService.updateClient` actualiza `Client`. | [`DIA-BE-CU-CAT-17`](backend-code-sequences/catalogs/cu-cat-17.md#cu-cat-17) |
| `CU-CAT-18` | `GET /api/sales/reports/clients/excel` → `exportClientReport`. | `clientService.findAllClients` prepara filas y el controller llama `sendExcelReport`. | [`DIA-BE-CU-CAT-18`](backend-code-sequences/catalogs/cu-cat-18.md#cu-cat-18) |
| `CU-CAT-19` | `GET /api/warehouse/wastes` → `getAllWastes`. | `wasteService.findAllWastes` consulta merma e inventario. | [`DIA-BE-CU-CAT-19`](backend-code-sequences/catalogs/cu-cat-19.md#cu-cat-19) |
| `CU-CAT-20` | `GET /api/warehouse/wastes/material-templates` y `POST /api/warehouse/wastes` → `getWasteMaterialTemplates`/`registerWaste`. | `findWasteMaterialTemplates` alimenta la selección y `createWasteWithInitialStockAdjustment` crea merma, ajuste y movimiento inicial. | [`DIA-BE-CU-CAT-20`](backend-code-sequences/catalogs/cu-cat-20.md#cu-cat-20) |
| `CU-CAT-21` | `PATCH /api/warehouse/wastes/:id` → `editWaste`. | `wasteService.updateWaste` actualiza datos sin tratar stock como edición. | [`DIA-BE-CU-CAT-21`](backend-code-sequences/catalogs/cu-cat-21.md#cu-cat-21) |
| `CU-CAT-22` | `PATCH /api/warehouse/wastes/:id/stock` → `editWasteStock`. | `wasteService.updateWasteStock` y `registerWasteStockAdjustment` aplican ajuste/movimiento. | [`DIA-BE-CU-CAT-22`](backend-code-sequences/catalogs/cu-cat-22.md#cu-cat-22) |
| `CU-CAT-23` | `GET /api/warehouse/wastes` → `getAllWastes`. | Reutiliza `wasteService.findAllWastes` con filtros; sólo lectura. | [`DIA-BE-CU-CAT-23`](backend-code-sequences/catalogs/cu-cat-23.md#cu-cat-23) |
| `CU-CAT-24` | `GET /api/warehouse/reports/wastes/excel` → `exportWasteReportExcel`. | `reportService.findWasteReportRows` aplica `inventoryScope` y `sendExcelReport`. | [`DIA-BE-CU-CAT-24`](backend-code-sequences/catalogs/cu-cat-24.md#cu-cat-24) |
| `CU-CAT-25` | `GET /api/admin/movements/wastes` → `getAllWasteMovements`. | `movementQueryService.findAllWasteMovements`; sólo lectura. | [`DIA-BE-CU-CAT-25`](backend-code-sequences/catalogs/cu-cat-25.md#cu-cat-25) |
| `CU-CAT-26` | `GET /api/admin/reports/movements/wastes/excel` → `exportWasteMovementReport`. | `inventory/reportService.findMovementReportRows` en contexto merma y respuesta Excel. | [`DIA-BE-CU-CAT-26`](backend-code-sequences/catalogs/cu-cat-26.md#cu-cat-26) |
| `CU-CAT-27` | `GET /api/warehouse/presentations` → `getAllPresentations`. | `presentationService.findAllPresentations` sirve el catálogo de sólo lectura. | [`DIA-BE-CU-CAT-27`](backend-code-sequences/catalogs/cu-cat-27.md#cu-cat-27) |
| `CU-CAT-28` | `GET /api/warehouse/unit-measures` → `getAllUnitMeasures`. | `unitMeasureService.findAllUnitMeasures` sirve el catálogo de sólo lectura. | [`DIA-BE-CU-CAT-28`](backend-code-sequences/catalogs/cu-cat-28.md#cu-cat-28) |
| `CU-CAT-29` | `GET /api/warehouse/reasons` → `getAllReasons`. | `reasonService.findAllReasons` sirve motivos; helpers resuelven motivos internos. | [`DIA-BE-CU-CAT-29`](backend-code-sequences/catalogs/cu-cat-29.md#cu-cat-29) |
| `CU-CAT-30` | `GET /api/warehouse/fulfillment-statuses` → `getAllFulfillmentStatuses`. | `fulfillmentStatusService.findAllFulfillmentStatuses` sirve estados de sólo lectura. | [`DIA-BE-CU-CAT-30`](backend-code-sequences/catalogs/cu-cat-30.md#cu-cat-30) |
| `CU-CAT-31` | `GET /api/admin/catalogs/departments` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Áreas. | [`DIA-BE-CU-CAT-31`](backend-code-sequences/catalogs/cu-cat-31.md#cu-cat-31) |
| `CU-CAT-32` | `POST /api/admin/catalogs/departments` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Áreas. | [`DIA-BE-CU-CAT-32`](backend-code-sequences/catalogs/cu-cat-32.md#cu-cat-32) |
| `CU-CAT-33` | `PUT /api/admin/catalogs/departments/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Áreas. | [`DIA-BE-CU-CAT-33`](backend-code-sequences/catalogs/cu-cat-33.md#cu-cat-33) |
| `CU-CAT-34` | `GET /api/admin/catalogs/roles` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Roles. | [`DIA-BE-CU-CAT-34`](backend-code-sequences/catalogs/cu-cat-34.md#cu-cat-34) |
| `CU-CAT-35` | `POST /api/admin/catalogs/roles` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Roles. | [`DIA-BE-CU-CAT-35`](backend-code-sequences/catalogs/cu-cat-35.md#cu-cat-35) |
| `CU-CAT-36` | `PUT /api/admin/catalogs/roles/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Roles. | [`DIA-BE-CU-CAT-36`](backend-code-sequences/catalogs/cu-cat-36.md#cu-cat-36) |
| `CU-CAT-37` | `GET /api/admin/catalogs/presentations` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Presentaciones. | [`DIA-BE-CU-CAT-37`](backend-code-sequences/catalogs/cu-cat-37.md#cu-cat-37) |
| `CU-CAT-38` | `POST /api/admin/catalogs/presentations` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Presentaciones. | [`DIA-BE-CU-CAT-38`](backend-code-sequences/catalogs/cu-cat-38.md#cu-cat-38) |
| `CU-CAT-39` | `PUT /api/admin/catalogs/presentations/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Presentaciones. | [`DIA-BE-CU-CAT-39`](backend-code-sequences/catalogs/cu-cat-39.md#cu-cat-39) |
| `CU-CAT-40` | `GET /api/admin/catalogs/unit-measures` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Unidades de medida. | [`DIA-BE-CU-CAT-40`](backend-code-sequences/catalogs/cu-cat-40.md#cu-cat-40) |
| `CU-CAT-41` | `POST /api/admin/catalogs/unit-measures` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Unidades de medida. | [`DIA-BE-CU-CAT-41`](backend-code-sequences/catalogs/cu-cat-41.md#cu-cat-41) |
| `CU-CAT-42` | `PUT /api/admin/catalogs/unit-measures/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Unidades de medida. | [`DIA-BE-CU-CAT-42`](backend-code-sequences/catalogs/cu-cat-42.md#cu-cat-42) |
| `CU-CAT-43` | `GET /api/admin/catalogs/reasons` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Motivos de ajuste. | [`DIA-BE-CU-CAT-43`](backend-code-sequences/catalogs/cu-cat-43.md#cu-cat-43) |
| `CU-CAT-44` | `POST /api/admin/catalogs/reasons` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Motivos de ajuste. | [`DIA-BE-CU-CAT-44`](backend-code-sequences/catalogs/cu-cat-44.md#cu-cat-44) |
| `CU-CAT-45` | `PUT /api/admin/catalogs/reasons/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Motivos de ajuste. | [`DIA-BE-CU-CAT-45`](backend-code-sequences/catalogs/cu-cat-45.md#cu-cat-45) |
| `CU-CAT-46` | `GET /api/admin/catalogs/fulfillment-statuses` → `getAllCatalogEntries`. | `catalogService.findAllCatalogEntries` opera exclusivamente sobre Estados de cumplimiento. | [`DIA-BE-CU-CAT-46`](backend-code-sequences/catalogs/cu-cat-46.md#cu-cat-46) |
| `CU-CAT-47` | `POST /api/admin/catalogs/fulfillment-statuses` → `registerCatalogEntry`. | `catalogService.createCatalogEntry` opera exclusivamente sobre Estados de cumplimiento. | [`DIA-BE-CU-CAT-47`](backend-code-sequences/catalogs/cu-cat-47.md#cu-cat-47) |
| `CU-CAT-48` | `PUT /api/admin/catalogs/fulfillment-statuses/:id` → `editCatalogEntry`. | `catalogService.updateCatalogEntry` opera exclusivamente sobre Estados de cumplimiento. | [`DIA-BE-CU-CAT-48`](backend-code-sequences/catalogs/cu-cat-48.md#cu-cat-48) |
