...
[diagramas backend aplicados al código](backend-use-case-diagrams.md). Cada vista por
...
vistas dinámicas anteriores. Cada caso conserva una secuencia con los elementos
concretos de sus capas y sólo referencia los patrones que aplica. Los `flowchart` se
mantienen únicamente en las actividades con decisiones; los casos cuyo ciclo técnico
aporta información incluyen además una vista de estados. Los flujos con coordinación
compleja conservan su secuencia o actividad detallada en esta misma sección.

#### `CU-AUT-01`

**Identificador:** `DIA-BE-TEC-CU-AUT-01`. **Patrones:** `BE-P01`, `BE-P08`.
...
sequenceDiagram
    ...
    participant Domain as Aplicación / dominio

    Client->>Route: iniciar caso
    Route->>Controller: entregar request o navegación
    Controller->>Domain: authService.loginUser, userService.getUserIdByLogin, JWT y cookies
    Domain-->>Controller: resultado o error del caso
    Controller-->>Client: respuesta observable
```

#### `CU-AUT-02`

**Identificador:** `DIA-BE-TEC-CU-AUT-02`. **Patrones:** `BE-P08`.
...
**Identificador:** `DIA-BE-TEC-CU-IDA-01`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-IDA-02`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-IDA-03`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-IDA-04`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-IDA-05`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-IDA-06`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-IDA-07`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-IDA-08`. **Patrones:** `BE-P02`.
...
**Identificador:** `DIA-BE-TEC-CU-IDA-09`. **Patrones:** `BE-P02`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-01`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-02`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-03`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-04`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-05`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-06`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-07`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-08`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-09`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-10`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-11`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-12`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-13`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-14`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-15`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-16`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-17`. **Patrones:** `BE-P02`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-18`. **Patrones:** `BE-P02`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-19`. **Patrones:** `BE-P02`.
...
**Identificador:** `DIA-BE-TEC-CU-CAT-20`. **Patrones:** `BE-P02`.
...
**Identificador:** `DIA-BE-TEC-CU-ENT-01`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-ENT-02`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-ENT-03`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-ENT-04`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-ENT-05`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-01`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-02`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-03`. **Patrones:** `BE-P01`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-04`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-05`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-06`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-07`. **Patrones:** `BE-P01`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-08`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-09`. **Patrones:** `BE-P01`, `BE-P04`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-10`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-11`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-SAL-12`. **Patrones:** `BE-P01`, `BE-P03`, `BE-P04`, `BE-P05`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-01`. **Patrones:** `BE-P06`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-02`. **Patrones:** `BE-P06`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-03`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-04`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-05`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-06`. **Patrones:** `BE-P06`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-07`. **Patrones:** `BE-P06`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-08`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-09`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-10`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-11`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-12`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-13`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-14`. **Patrones:** `BE-P07`.
...
**Identificador:** `DIA-BE-TEC-CU-REP-15`. **Patrones:** `BE-P07`.
