...
| Generar reporte Excel | Controllers de reporte, servicios de consulta y `reportExcelUtils.js`. | [Canal de generación](../../requirements/diagrams/cross-cutting/17-generate-reports-specific-cu-ida-04-cu-ida-09-cu-alm-06-cu-alm-08-cu-.md#17-generar-reportes-específicos--cu-ida-04-cu-ida-09-cu-alm-06-cu-alm-08-cu-cat-04-cu-cat-08-cu-alm-13-cu-alm-15-cu-ent-06-cu-sal-07-y-cu-sal-14). |
