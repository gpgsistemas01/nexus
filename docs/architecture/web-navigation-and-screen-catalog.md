...
| Almacén | Consumibles (`/almacen/consumibles`) | Alojar el futuro módulo de consumibles. | Sin interacciones por el momento. | `src/views/pages/warehouse/consumables/consumablesPage.ejs` |
