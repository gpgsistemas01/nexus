...
| Entradas de compra | Integración desde controller para creación, corrección, costos y movimientos; cancelación pendiente. | Completar cancelación, relaciones protegidas y rollback. |
