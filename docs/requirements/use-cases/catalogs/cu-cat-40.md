# `CU-CAT-40` — Crear motivo de ajuste

| Sección | Información relevante |
| --- | --- |
| Identificador | `CU-CAT-40` |
| Nombre | Crear motivo de ajuste. |
| Actor y disparador | **Actor:** Administrador del sistema del área Sistemas. **Disparador:** selecciona **Nuevo motivo de ajuste** en `CU-CAT-39` Consultar motivo de ajuste. |
