...
| Actor y disparador | **Actor:** Usuario con permiso sobre el reporte o consulta. **Disparador:** desde `CU-CAT-01` Consultar materiales, selecciona **Exportar Excel** con los filtros que necesita conservar. |
