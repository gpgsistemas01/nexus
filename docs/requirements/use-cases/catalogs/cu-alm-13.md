...
| Actor y disparador | **Actor:** Personal de almacén o Administrador del sistema. **Disparador:** desde `CU-ALM-09` Consultar mermas, selecciona **Exportar Excel** con los filtros que necesita conservar. |
