...
| Actor y disparador | **Actor:** Administrador del sistema. **Disparador:** desde `CU-CAT-05` Consultar clientes, selecciona la opción para generar el reporte con los filtros que necesita conservar. |
