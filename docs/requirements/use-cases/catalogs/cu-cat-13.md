...
| Actor y disparador | **Actor:** Usuario con permiso sobre el reporte o consulta. **Disparador:** desde `CU-CAT-09` Consultar proveedores, selecciona la opción para generar el reporte con los filtros que necesita conservar. |
