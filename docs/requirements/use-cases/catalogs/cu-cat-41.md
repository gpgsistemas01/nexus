...
| Actor y disparador | **Actor:** Administrador del sistema del área Sistemas. **Disparador:** selecciona **Nuevo estado de cumplimiento** en `CU-CAT-40` Consultar estado de cumplimiento. |
