# `CU-CAT-34` — Crear presentación

| Sección | Información relevante |
| --- | --- |
| Identificador | `CU-CAT-34` |
| Nombre | Crear presentación. |
| Actor y disparador | **Actor:** Administrador del sistema del área Sistemas. **Disparador:** selecciona **Nueva presentación** en `CU-CAT-33` Consultar presentación. |
