...
| Actor y disparador | **Actor:** Usuario con permiso sobre el reporte o consulta. **Disparador:** desde `CU-CAT-23` Consultar movimientos de mermas, selecciona **Exportar Excel** con los filtros que necesita conservar. |
