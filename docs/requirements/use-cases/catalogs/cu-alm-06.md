...
| Actor y disparador | **Actor:** Personal de almacén o Administrador del sistema. **Disparador:** desde `CU-ALM-01` Consultar materiales, selecciona **Exportar Excel** con los filtros que necesita conservar. |
