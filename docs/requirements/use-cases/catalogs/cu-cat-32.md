# `CU-CAT-32` — Crear presentación

| Sección | Información relevante |
| --- | --- |
| Identificador | `CU-CAT-32` |
| Nombre | Crear presentación. |
| Actor y disparador | **Actor:** Administrador del sistema del área Sistemas. **Disparador:** selecciona **Nueva presentación** en `CU-CAT-31` Consultar presentación. |
