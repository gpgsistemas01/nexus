...
| Actor y disparador | **Actor:** Administrador del sistema del área Sistemas. **Disparador:** selecciona **Nuevo motivo de ajuste** en `CU-CAT-21` Consultar motivo de ajuste. |
