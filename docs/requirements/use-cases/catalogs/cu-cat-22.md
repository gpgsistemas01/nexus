...
| Disparador | Selecciona **Nuevo motivo de ajuste** en `CU-CAT-21` Consultar motivo de ajuste. |
...
| Flujo principal | 1. **Actor:** abre la pantalla **Motivos de ajuste** y selecciona **Nuevo motivo de ajuste** **(ver E1)**.<br>2. **Nexus:** presenta únicamente los campos **Nombre** y **Activo**.<br>3. **Actor:** captura los datos y selecciona **Guardar** **(ver A1)**.<br>4. **Nexus:** revisa la información y crea la entrada de Motivos de ajuste; confirma y refresca la tabla de Motivos de ajuste. Además, guarda los cambios de la operación en la base de datos **(ver EBD)**. |
