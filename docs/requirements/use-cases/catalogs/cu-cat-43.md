# `CU-CAT-43` — Crear estado de cumplimiento

| Sección | Información relevante |
| --- | --- |
| Identificador | `CU-CAT-43` |
| Nombre | Crear estado de cumplimiento. |
| Actor y disparador | **Actor:** Administrador del sistema del área Sistemas. **Disparador:** selecciona **Nuevo estado de cumplimiento** en `CU-CAT-42` Consultar estado de cumplimiento. |
