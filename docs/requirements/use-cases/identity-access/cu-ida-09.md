...
| Actor y disparador | **Actor:** Administrador del sistema. **Disparador:** desde `CU-IDA-05` Consultar usuarios, selecciona la opción para generar el reporte con los filtros que necesita conservar. |
