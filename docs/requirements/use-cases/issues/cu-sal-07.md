...
| Actor y disparador | **Actor:** Personal de almacén o Administrador del sistema. **Disparador:** desde `CU-SAL-01` Consultar salidas de material, selecciona la opción para generar el reporte con los filtros que necesita conservar. |
