...
| Actor y disparador | **Actor:** Personal de almacén o Administrador del sistema. **Disparador:** desde `CU-ENT-01` Consultar compras de material, selecciona la opción para generar el reporte con los filtros que necesita conservar. |
