...
flowchart LR
    ...
    subgraph catalogPackage["Nexus · Grupo funcional CAT: Catálogos"]
        ...
        subgraph auxiliaryCatalogFamily["Catálogos auxiliares"]
            ucCatalog21(["CU-CAT-09 Consultar área"])
            ucCatalog22(["CU-CAT-10 Crear área"])
            ucCatalog23(["CU-CAT-11 Editar área"])
            ucCatalog24(["CU-CAT-12 Consultar rol"])
            ucCatalog25(["CU-CAT-13 Crear rol"])
            ucCatalog26(["CU-CAT-14 Editar rol"])
            ucCatalog27(["CU-CAT-15 Consultar presentación"])
            ucCatalog28(["CU-CAT-16 Crear presentación"])
            ucCatalog29(["CU-CAT-17 Editar presentación"])
            ucCatalog30(["CU-CAT-18 Consultar unidad de medida"])
            ucCatalog31(["CU-CAT-19 Crear unidad de medida"])
            ucCatalog32(["CU-CAT-20 Editar unidad de medida"])
            ucCatalog33(["CU-CAT-21 Consultar motivo de ajuste"])
            ucCatalog34(["CU-CAT-22 Crear motivo de ajuste"])
            ucCatalog35(["CU-CAT-23 Editar motivo de ajuste"])
            ucCatalog36(["CU-CAT-24 Consultar estado de cumplimiento"])
            ucCatalog37(["CU-CAT-25 Crear estado de cumplimiento"])
            ucCatalog38(["CU-CAT-26 Editar estado de cumplimiento"])
        end
    end
