...
orientada al código.
- [Consultar personas y usuarios — `CU-IDA-01` y `CU-IDA-05`](01-consultar-personas-y-usuarios-cu-ida-01-y-cu-ida-05.md)
- [Crear persona — `CU-IDA-02`](02-crear-persona-cu-ida-02.md)
- [Editar persona — `CU-IDA-03`](03-editar-persona-cu-ida-03.md)
- [Patrón de consulta de catálogos — `CU-CAT-01`, `CU-CAT-10`, `CU-CAT-15`, `CU-CAT-19` y `CU-CAT-27` a `CU-CAT-30`; `CU-CAT-31`, `CU-CAT-34`, `CU-CAT-37`, `CU-CAT-40`, `CU-CAT-43` y `CU-CAT-46`](04-patron-de-consulta-de-catalogos-cu-cat-01-cu-cat-10-cu-cat-15-cu-cat-19-.md)
- [Patrón de alta de catálogos — `CU-CAT-02`, `CU-CAT-11`, `CU-CAT-16`, `CU-CAT-20`, `CU-CAT-32`, `CU-CAT-35`, `CU-CAT-38`, `CU-CAT-41`, `CU-CAT-44` y `CU-CAT-47`](05-patron-de-alta-de-catalogos-cu-cat-02-cu-cat-11-cu-cat-16-cu-cat-20-cu-c.md)
- [Patrón de edición de catálogos — `CU-CAT-03`, `CU-CAT-12`, `CU-CAT-17`, `CU-CAT-21`, `CU-CAT-33`, `CU-CAT-36`, `CU-CAT-39`, `CU-CAT-42`, `CU-CAT-45` y `CU-CAT-48`](06-patron-de-edicion-de-catalogos-cu-cat-03-cu-cat-12-cu-cat-17-cu-cat-21-c.md)
- [Consultar compras de material — `CU-ENT-01`](07-consultar-compras-de-material-cu-ent-01.md)
- [Editar compra de material — `CU-ENT-03`](08-editar-compra-de-material-cu-ent-03.md)
- [Consultar salidas de material o de merma — `CU-SAL-01` y `CU-SAL-08`](09-consultar-salidas-de-material-o-de-merma-cu-sal-01-y-cu-sal-08.md)
- [Crear salida de material o de merma — `CU-SAL-02` y `CU-SAL-09`](10-crear-salida-de-material-o-de-merma-cu-sal-02-y-cu-sal-09.md)
- [Editar encabezado de salida de material o de merma — `CU-SAL-03` y `CU-SAL-10`](11-editar-encabezado-de-salida-de-material-o-de-merma-cu-sal-03-y-cu-sal-10.md)
- [Editar detalles de material o merma de una salida — `CU-SAL-04` y `CU-SAL-11`](12-editar-detalles-de-material-o-merma-de-una-salida-cu-sal-04-y-cu-sal-11.md)
- [Consultar inventarios y movimientos — `CU-CAT-06`, `CU-CAT-08`, `CU-CAT-23` y `CU-CAT-25`](13-consultar-inventarios-y-movimientos-cu-cat-06-cu-cat-08-cu-cat-23-y-cu-c.md)
- [Crear o editar usuario y acceso — `CU-IDA-06`, `CU-IDA-07`, `CU-IDA-08`](14-crear-o-editar-usuario-y-acceso-cu-ida-06-cu-ida-07-cu-ida-08.md)
- [Eliminar material o relación de proveedor — `CU-CAT-04`](15-eliminar-material-o-relacion-de-proveedor-cu-cat-04.md)
- [Crear compra de material — `CU-ENT-02`](16-crear-compra-de-material-cu-ent-02.md)
- [Generar reportes específicos — `CU-IDA-04`, `CU-IDA-09`, `CU-CAT-07`, `CU-CAT-09`, `CU-CAT-14`, `CU-CAT-18`, `CU-CAT-24`, `CU-CAT-26`, `CU-ENT-06`, `CU-SAL-07` y `CU-SAL-14`](17-generar-reportes-especificos-cu-ida-04-cu-ida-09-cu-cat-07-cu-cat-09-cu-.md)

## Coordinación atómica de correcciones de entrada

- [Coordinación atómica de correcciones de entrada](18-coordinacion-atomica-de-correcciones-de-entrada.md)
...
- [Derivación de la cancelación del encabezado](19-derivacion-de-la-cancelacion-del-encabezado.md)

## Requisitos de calidad y restricciones

- [Requisitos de calidad y restricciones](20-requisitos-de-calidad-y-restricciones.md)

## Trazabilidad del requisito a la evidencia

- [Trazabilidad del requisito a la evidencia](21-trazabilidad-del-requisito-a-la-evidencia.md)
