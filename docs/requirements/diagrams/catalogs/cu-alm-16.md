...
```mermaid
flowchart LR
    accTitle: CU-ALM-16 — Generar reporte de movimientos de mermas
    request["Actor selecciona exportar desde CU-ALM-15: movimientos de mermas"] --> modal["Nexus abre el modal Exportar reporte"]
