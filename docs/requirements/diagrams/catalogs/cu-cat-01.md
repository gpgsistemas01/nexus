...
```mermaid
flowchart LR
    accTitle: CU-CAT-01 — Consultar proveedores
    ...
    result --> edit["Actor elige editar y puede iniciar CU-CAT-03"]
    result --> report["Actor elige exportar y puede iniciar CU-CAT-04"]
```
