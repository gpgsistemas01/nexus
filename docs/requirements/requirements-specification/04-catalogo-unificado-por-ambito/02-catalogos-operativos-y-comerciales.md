...
| RF-CAT-002 | Administración debe poder consultar proveedores autorizados sin modificar sus datos. | Implementado | `src/routes/api/warehouse/supplierApiRoute.js` |
...
| RF-CAT-010 | Almacén o Administración deben poder crear un proveedor con razón social, nombre comercial y estado válido; el sistema debe asignarle un código único. | Implementado | `src/routes/api/warehouse/supplierApiRoute.js`, `src/services/warehouse/supplierService.js` |
...
| RF-CAT-013 | Almacén o Administración deben poder crear un cliente con estado activo válido; cuando indique un asesor, éste debe corresponder a una persona registrada. | Implementado | `src/routes/api/sales/clientApiRoute.js`, `tests/integration/controllers/clientControllerDbTest.js` |
