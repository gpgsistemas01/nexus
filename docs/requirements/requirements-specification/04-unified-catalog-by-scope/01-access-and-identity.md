...
| RF-IAM-007 | El Administrador del sistema del área Sistemas debe poder crear una persona con identidad y asignaciones válidas, sin crear por ello una cuenta de acceso. | Implementado | `src/routes/api/admin/personApiRoute.js`, `src/views/pages/admin/persons` |
| RF-IAM-008 | El Administrador del sistema del área Sistemas debe poder actualizar los datos y asignaciones admitidos de una persona existente. | Implementado | `src/routes/api/admin/personApiRoute.js`, `src/views/pages/admin/persons` |
