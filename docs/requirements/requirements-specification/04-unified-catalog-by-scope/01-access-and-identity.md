...
| RF-IAM-002 | Personal de almacén o el Administrador del sistema deben poder consultar personas y sus asignaciones sin concederles acceso implícito. | Implementado | `src/routes/api/admin/personApiRoute.js`, `src/views/pages/admin/persons` |
...
| RF-IAM-005 | El Administrador del sistema del área Sistemas debe poder actualizar los datos admitidos y reemplazar atómicamente la asignación de acceso de un usuario. | Implementado | `src/routes/api/admin/userApiRoute.js`, `src/services/admin/userService.js` |
| RF-IAM-006 | El Administrador del sistema del área Sistemas debe poder cambiar la contraseña de un usuario almacenando únicamente su representación cifrada. | Implementado | `src/routes/api/admin/userApiRoute.js`, `src/services/admin/userService.js` |
| RF-IAM-007 | El Administrador del sistema del área Sistemas debe poder crear una persona con identidad y asignaciones válidas, sin repetir un área ni crear por ello una cuenta de acceso. | Implementado | `src/routes/api/admin/personApiRoute.js`, `src/views/pages/admin/persons` |
| RF-IAM-008 | El Administrador del sistema del área Sistemas debe poder actualizar los datos y asignaciones admitidos de una persona existente, conservando como máximo un rol por área. | Implementado | `src/routes/api/admin/personApiRoute.js`, `src/views/pages/admin/persons` |
