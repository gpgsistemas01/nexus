...
3. Capture una **Cantidad a agregar** mayor que cero. Si necesita dejar contexto para el
   historial, capture **Observaciones de la entrada (opcional)**; esta nota se guarda en el
   documento individual de entrada, vinculado con su movimiento `ENTRY`.
4. Seleccione **Agregar** y compruebe que la existencia aumentó exactamente esa cantidad.
