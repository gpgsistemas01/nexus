...
| Material o merma / edición | Identidad y datos secundarios admitidos para el recurso; sólo se validan los campos habilitados y la existencia no cambia | Al seleccionar **Actualizar** | Conserve el formulario y corrija el campo señalado; use **Agregar stock** para incrementar la existencia o, si es Administrador, **Ajustar stock** para reemplazarla. |
