...
| Catálogos auxiliares | **Nombre** requerido y sin caracteres no admitidos; máximo 50 para Áreas, Roles, Presentaciones y Estados de cumplimiento, 20 para Unidades de medida y 100 para Motivos de ajuste; **Símbolo** requerido y máximo 10 sólo en Unidades de medida; **Activo** booleano requerido sólo en Motivos de ajuste | En alta y edición, antes de invocar el controller | El formulario permanece abierto y señala el campo; una solicitud rechazada no modifica el catálogo. |
