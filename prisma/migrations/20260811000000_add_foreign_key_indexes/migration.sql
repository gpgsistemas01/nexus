...
--
-- Five materialId indexes can already exist because they were introduced by
-- 20260810183000_index_material_operational_relations. IF NOT EXISTS keeps this
-- migration safe for databases that have already applied that migration.
