...
--
-- The materialId indexes introduced by
-- 20260810183000_index_material_operational_relations are intentionally omitted
-- here so the migration history has a single owner for each index.
