...
const captures = [
    ...
    { id: 'CAP-CAT-MAT-01-LIST', module: 'materiales', name: '01-listado-inventario.png', route: '/almacen/materiales', ready: '#table', action: openFilters, useCases: ['CU-CAT-01', 'CU-CAT-06', 'CU-CAT-07'] },
    { id: 'CAP-CAT-MAT-02-CREATE', module: 'materiales', name: '02-formulario-alta.png', route: '/almacen/materiales', ready: '#table', action: click('button:has-text("Nuevo material")', '#materialModal.show'), useCases: ['CU-CAT-02', 'CU-CAT-27', 'CU-CAT-28'] },
    ...
    { id: 'CAP-CAT-MAT-04-STOCK', module: 'materiales', name: '04-ajuste-existencia.png', route: '/almacen/materiales', ready: '#table', action: click('#table tbody .btn-adjust-stock', '#materialModal.show'), useCases: ['CU-CAT-05', 'CU-CAT-29'] },
    { id: 'CAP-REP-MAT-05-EXPORT', module: 'materiales', name: '05-exportar-reporte.png', route: '/almacen/materiales', ready: '#table', action: reportDialog, useCases: ['CU-CAT-07'] },

    { id: 'CAP-CAT-SUP-00-NAVIGATION', module: 'proveedores', name: '00-acceso-menu-principal.png', route: '/proveedores', ready: '#table', action: openMainMenu, useCases: ['CU-CAT-10'] },
    { id: 'CAP-CAT-SUP-01-LIST', module: 'proveedores', name: '01-listado.png', route: '/proveedores', ready: '#table', useCases: ['CU-CAT-10', 'CU-CAT-14'] },
    { id: 'CAP-CAT-SUP-02-CREATE', module: 'proveedores', name: '02-formulario-alta.png', route: '/proveedores', ready: '#table', action: click('button:has-text("Nuevo proveedor")', '#supplierModal.show'), useCases: ['CU-CAT-11'] },
    { id: 'CAP-CAT-SUP-03-EDIT', module: 'proveedores', name: '03-formulario-edicion-y-estado.png', route: '/proveedores', ready: '#table', action: click('#table tbody .btn-edit', '#supplierModal.show'), useCases: ['CU-CAT-12', 'CU-CAT-13'] },
    { id: 'CAP-CAT-SUP-04-EXPORT', module: 'proveedores', name: '04-exportar-reporte.png', route: '/proveedores', ready: '#table', action: reportDialog, useCases: ['CU-CAT-14'] },

    { id: 'CAP-CAT-CLI-00-NAVIGATION', module: 'clientes', name: '00-acceso-menu-principal.png', route: '/clientes', ready: '#table', action: openMainMenu, useCases: ['CU-CAT-15'] },
    { id: 'CAP-CAT-CLI-01-LIST', module: 'clientes', name: '01-listado.png', route: '/clientes', ready: '#table', useCases: ['CU-CAT-15', 'CU-CAT-18'] },
    { id: 'CAP-CAT-CLI-02-CREATE', module: 'clientes', name: '02-formulario-alta.png', route: '/clientes', ready: '#table', action: click('button:has-text("Nuevo cliente")', '#clientModal.show'), useCases: ['CU-CAT-16'] },
    { id: 'CAP-CAT-CLI-03-EDIT', module: 'clientes', name: '03-formulario-edicion.png', route: '/clientes', ready: '#table', action: click('#table tbody .btn-edit', '#clientModal.show'), useCases: ['CU-CAT-17'] },
    { id: 'CAP-CAT-CLI-04-EXPORT', module: 'clientes', name: '04-exportar-reporte.png', route: '/clientes', ready: '#table', action: reportDialog, useCases: ['CU-CAT-18'] },

    { id: 'CAP-CAT-WAS-00-NAVIGATION', module: 'mermas', name: '00-acceso-menu-principal.png', route: '/almacen/mermas', ready: '#table', action: openMainMenu, useCases: ['CU-CAT-19'] },
    { id: 'CAP-CAT-WAS-01-LIST', module: 'mermas', name: '01-listado-inventario.png', route: '/almacen/mermas', ready: '#table', action: openFilters, useCases: ['CU-CAT-19', 'CU-CAT-23', 'CU-CAT-24'] },
    { id: 'CAP-CAT-WAS-02-CREATE', module: 'mermas', name: '02-formulario-registro.png', route: '/almacen/mermas', ready: '#table', action: click('button:has-text("Nueva merma")', '#wasteModal.show'), useCases: ['CU-CAT-20'] },
    { id: 'CAP-CAT-WAS-03-EDIT', module: 'mermas', name: '03-formulario-edicion.png', route: '/almacen/mermas', ready: '#table', action: click('#table tbody .btn-edit', '#wasteModal.show'), useCases: ['CU-CAT-21'] },
    ...
    { id: 'CAP-REP-ENT-05-EXPORT', module: 'compras', name: '05-exportar-reporte.png', route: '/compras', ready: '#table', action: reportDialog, useCases: ['CU-ENT-06'] },
    ...
    { id: 'CAP-SAL-MAT-01-LIST', module: 'salidas-material', name: '01-listado.png', route: '/salidas/materiales', ready: '#table', action: openFilters, useCases: ['CU-CAT-30', 'CU-SAL-01'] },
    ...
    { id: 'CAP-REP-SAL-MAT-06-EXPORT', module: 'salidas-material', name: '06-exportar-reporte.png', route: '/salidas/materiales', ready: '#table', action: reportDialog, useCases: ['CU-SAL-07'] },
    ...
    { id: 'CAP-SAL-WAS-00-NAVIGATION', module: 'salidas-merma', name: '00-acceso-menu-principal.png', route: '/salidas/mermas', ready: '#table', action: openMainMenu, useCases: ['CU-SAL-08'] },
    { id: 'CAP-SAL-WAS-01-LIST', module: 'salidas-merma', name: '01-listado.png', route: '/salidas/mermas', ready: '#table', action: openFilters, useCases: ['CU-SAL-08', 'CU-SAL-14'] },
    { id: 'CAP-SAL-WAS-02-CREATE', module: 'salidas-merma', name: '02-formulario-registro.png', route: '/salidas/mermas', ready: '#table', action: click('button:has-text("Nueva salida")', '#wasteIssueModal.show', 'el permiso para administrar salidas de merma'), useCases: ['CU-SAL-09'] },
    { id: 'CAP-SAL-WAS-03-EDIT', module: 'salidas-merma', name: '03-edicion-encabezado.png', route: '/salidas/mermas', ready: '#table', action: click('#table tbody .btn-edit', '#wasteIssueModal.show'), useCases: ['CU-SAL-10', 'CU-SAL-11'] },
    { id: 'CAP-SAL-WAS-04-SUPPLY', module: 'salidas-merma', name: '04-surtir-detalles.png', route: '/salidas/mermas', ready: '#table', action: click('#table tbody .btn-edit-detail', '#wasteIssueModal.show'), useCases: ['CU-SAL-12'] },
    ...
    { id: 'CAP-REP-SAL-WAS-06-EXPORT', module: 'salidas-merma', name: '06-exportar-reporte.png', route: '/salidas/mermas', ready: '#table', action: reportDialog, useCases: ['CU-SAL-14'] },
    { id: 'CAP-SAL-WAS-07-FILTER', module: 'salidas-merma', name: '07-filtro-surtido.png', route: '/salidas/mermas', ready: '#table', action: filter('#fulfillmentStatusFilter', 'Surtido'), useCases: ['CU-SAL-08', 'CU-SAL-13'] },
    { id: 'CAP-SAL-WAS-08-VIEW', module: 'salidas-merma', name: '08-consulta-cancelada.png', route: '/salidas/mermas', ready: '#table', actions: [filter('#fulfillmentStatusFilter', 'Cancelado'), clickStatus('Cancelada', '.btn-edit', '#wasteIssueModal.show', 'una salida de merma cancelada')], useCases: ['CU-SAL-10', 'CU-SAL-11'] },
    ...
    { id: 'CAP-IDA-PER-01-LIST', module: 'personas', name: '01-listado.png', route: '/personas', ready: '#table', action: openFilters, useCases: ['CU-IDA-01', 'CU-IDA-04'] },
    { id: 'CAP-IDA-PER-02-CREATE', module: 'personas', name: '02-formulario-alta.png', route: '/personas', ready: '#table', action: click('button:has-text("Nueva persona")', '#personModal.show'), useCases: ['CU-IDA-02', 'CU-IDA-10', 'CU-IDA-11'] },
    ...
    { id: 'CAP-IDA-PER-04-EXPORT', module: 'personas', name: '04-exportar-reporte.png', route: '/personas', ready: '#table', action: reportDialog, useCases: ['CU-IDA-04'] },

    { id: 'CAP-IDA-USR-00-NAVIGATION', module: 'usuarios', name: '00-acceso-menu-principal.png', route: '/usuarios-sistemas', ready: '#table', action: openMainMenu, useCases: ['CU-IDA-05'] },
    { id: 'CAP-IDA-USR-01-LIST', module: 'usuarios', name: '01-listado.png', route: '/usuarios-sistemas', ready: '#table', useCases: ['CU-IDA-05', 'CU-IDA-09'] },
    { id: 'CAP-IDA-USR-02-CREATE', module: 'usuarios', name: '02-formulario-alta.png', route: '/usuarios-sistemas', ready: '#table', action: click('button:has-text("Nuevo usuario")', '#userModal.show'), useCases: ['CU-IDA-06'] },
    { id: 'CAP-IDA-USR-03-EDIT', module: 'usuarios', name: '03-formulario-edicion.png', route: '/usuarios-sistemas', ready: '#table', action: click('#table tbody .btn-edit', '#userModal.show'), useCases: ['CU-IDA-07'] },
    { id: 'CAP-IDA-USR-04-PASSWORD', module: 'usuarios', name: '04-cambio-contrasena.png', route: '/usuarios-sistemas', ready: '#table', action: click('#table tbody .btn-edit-password', '#userModal.show'), useCases: ['CU-IDA-08'] },
    { id: 'CAP-IDA-USR-05-EXPORT', module: 'usuarios', name: '05-exportar-reporte.png', route: '/usuarios-sistemas', ready: '#table', action: reportDialog, useCases: ['CU-IDA-09'] },

    { id: 'CAP-REP-MOV-MAT-00-NAVIGATION', module: 'movimientos-material', name: '00-acceso-menu-principal.png', route: '/movimientos/materiales', ready: '#materialMovementTable', action: openMainMenu, useCases: ['CU-CAT-08'] },
    { id: 'CAP-REP-MOV-MAT-01-LIST', module: 'movimientos-material', name: '01-historial-y-filtros.png', route: '/movimientos/materiales', ready: '#materialMovementTable', action: openFilters, useCases: ['CU-CAT-08'] },
    { id: 'CAP-REP-MOV-MAT-02-EXPORT', module: 'movimientos-material', name: '02-exportar-reporte.png', route: '/movimientos/materiales', ready: '#materialMovementTable', action: reportDialog, useCases: ['CU-CAT-09'] },
    { id: 'CAP-REP-MOV-WAS-00-NAVIGATION', module: 'movimientos-merma', name: '00-acceso-menu-principal.png', route: '/movimientos/mermas', ready: '#wasteMovementTable', action: openMainMenu, useCases: ['CU-CAT-25'] },
    { id: 'CAP-REP-MOV-WAS-01-LIST', module: 'movimientos-merma', name: '01-historial-y-filtros.png', route: '/movimientos/mermas', ready: '#wasteMovementTable', action: openFilters, useCases: ['CU-CAT-25'] },
    { id: 'CAP-REP-MOV-WAS-02-EXPORT', module: 'movimientos-merma', name: '02-exportar-reporte.png', route: '/movimientos/mermas', ready: '#wasteMovementTable', action: reportDialog, useCases: ['CU-CAT-26'] },
