...
const captures = [
    ...
    { id: 'CAP-CAT-AREA-01-LIST', module: 'catalogos/areas', name: '01-listado.png', route: '/catalogos/departments', ready: '#table', useCases: ['CU-CAT-21'] },
    { id: 'CAP-CAT-AREA-02-CREATE', module: 'catalogos/areas', name: '02-formulario-alta.png', route: '/catalogos/departments', ready: '#table', action: click('button:has-text("Nuevo registro de área")', '#catalogModal.show'), useCases: ['CU-CAT-22'] },
    { id: 'CAP-CAT-AREA-03-EDIT', module: 'catalogos/areas', name: '03-formulario-edicion.png', route: '/catalogos/departments', ready: '#table', action: click('#table tbody .btn-edit', '#catalogModal.show', 'al menos un área'), useCases: ['CU-CAT-23'] },
    { id: 'CAP-CAT-ROLE-01-LIST', module: 'catalogos/roles', name: '01-listado.png', route: '/catalogos/roles', ready: '#table', useCases: ['CU-CAT-24'] },
    { id: 'CAP-CAT-ROLE-02-CREATE', module: 'catalogos/roles', name: '02-formulario-alta.png', route: '/catalogos/roles', ready: '#table', action: click('button:has-text("Nuevo registro de rol")', '#catalogModal.show'), useCases: ['CU-CAT-25'] },
    { id: 'CAP-CAT-ROLE-03-EDIT', module: 'catalogos/roles', name: '03-formulario-edicion.png', route: '/catalogos/roles', ready: '#table', action: click('#table tbody .btn-edit', '#catalogModal.show', 'al menos un rol'), useCases: ['CU-CAT-26'] },
    { id: 'CAP-CAT-PRE-01-LIST', module: 'catalogos/presentaciones', name: '01-listado.png', route: '/catalogos/presentations', ready: '#table', useCases: ['CU-CAT-27'] },
    { id: 'CAP-CAT-PRE-02-CREATE', module: 'catalogos/presentaciones', name: '02-formulario-alta.png', route: '/catalogos/presentations', ready: '#table', action: click('button:has-text("Nuevo registro de presentación")', '#catalogModal.show'), useCases: ['CU-CAT-28'] },
    { id: 'CAP-CAT-PRE-03-EDIT', module: 'catalogos/presentaciones', name: '03-formulario-edicion.png', route: '/catalogos/presentations', ready: '#table', action: click('#table tbody .btn-edit', '#catalogModal.show', 'al menos una presentación'), useCases: ['CU-CAT-29'] },
    { id: 'CAP-CAT-UNIT-01-LIST', module: 'catalogos/unidades-medida', name: '01-listado.png', route: '/catalogos/unit-measures', ready: '#table', useCases: ['CU-CAT-30'] },
    { id: 'CAP-CAT-UNIT-02-CREATE', module: 'catalogos/unidades-medida', name: '02-formulario-alta.png', route: '/catalogos/unit-measures', ready: '#table', action: click('button:has-text("Nuevo registro de unidad de medida")', '#catalogModal.show'), useCases: ['CU-CAT-31'] },
    { id: 'CAP-CAT-UNIT-03-EDIT', module: 'catalogos/unidades-medida', name: '03-formulario-edicion.png', route: '/catalogos/unit-measures', ready: '#table', action: click('#table tbody .btn-edit', '#catalogModal.show', 'al menos una unidad de medida'), useCases: ['CU-CAT-32'] },
    { id: 'CAP-CAT-REASON-01-LIST', module: 'catalogos/motivos-ajuste', name: '01-listado.png', route: '/catalogos/reasons', ready: '#table', useCases: ['CU-CAT-33'] },
    { id: 'CAP-CAT-REASON-02-CREATE', module: 'catalogos/motivos-ajuste', name: '02-formulario-alta.png', route: '/catalogos/reasons', ready: '#table', action: click('button:has-text("Nuevo registro de motivo de ajuste")', '#catalogModal.show'), useCases: ['CU-CAT-34'] },
    { id: 'CAP-CAT-REASON-03-EDIT', module: 'catalogos/motivos-ajuste', name: '03-formulario-edicion.png', route: '/catalogos/reasons', ready: '#table', action: click('#table tbody .btn-edit', '#catalogModal.show', 'al menos un motivo de ajuste'), useCases: ['CU-CAT-35'] },
    { id: 'CAP-CAT-STATUS-01-LIST', module: 'catalogos/estados-cumplimiento', name: '01-listado.png', route: '/catalogos/fulfillment-statuses', ready: '#table', useCases: ['CU-CAT-36'] },
    { id: 'CAP-CAT-STATUS-02-CREATE', module: 'catalogos/estados-cumplimiento', name: '02-formulario-alta.png', route: '/catalogos/fulfillment-statuses', ready: '#table', action: click('button:has-text("Nuevo registro de estado de cumplimiento")', '#catalogModal.show'), useCases: ['CU-CAT-37'] },
    { id: 'CAP-CAT-STATUS-03-EDIT', module: 'catalogos/estados-cumplimiento', name: '03-formulario-edicion.png', route: '/catalogos/fulfillment-statuses', ready: '#table', action: click('#table tbody .btn-edit', '#catalogModal.show', 'al menos un estado de cumplimiento'), useCases: ['CU-CAT-38'] },
