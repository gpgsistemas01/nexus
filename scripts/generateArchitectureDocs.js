...
const DATABASE_AREAS = [
    ...
    ['Mermas e inventario de merma', ['Waste', 'WasteIssue', 'WasteIssueDetail', 'WasteIssueReturn', 'WasteMovement', 'WasteMovementDetail', 'WasteStockEntry', 'WasteStockAdjustment', 'WasteStockAdjustmentDetail']]
];
