...
describe('plantillas de material para el CRUD de mermas', () => {
  ...
  it('devuelve materiales únicos y sólo sugiere la menor medida como ancho para rollos', async () => {
    materialFindMany.mockResolvedValue([
      { id: 'material-1', name: 'Lona', base: 50, height: 1.52, presentation: { name: 'ROLLO' } },
      { id: 'material-duplicate', name: 'Lona', base: 1.52, height: 100, presentation: { name: 'ROLLO' } },
      { id: 'material-wide', name: 'Lona', base: 3.2, height: 100, presentation: { name: 'ROLLO' } },
      { id: 'material-2', name: 'Vinil', base: 1.2, height: 100, presentation: { name: 'HOJA' } }
    ]);
    ...
    expect(result.data).toEqual([
      expect.objectContaining({ id: 'material-1', suggestedWidth: 1.52 }),
      expect.objectContaining({ id: 'material-wide', suggestedWidth: 3.2 }),
      expect.objectContaining({ id: 'material-2', suggestedWidth: null })
    ]);
  });
});
