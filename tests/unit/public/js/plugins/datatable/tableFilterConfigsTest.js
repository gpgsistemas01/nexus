...
vi.mock('../../../../../../src/public/js/application/warehouse/fulfillmentStatuses.js', () => ({
  getFulfillmentStatusOptions: vi.fn()
}));
vi.mock('../../../../../../src/public/js/application/admin/persons.js', () => ({
...
const { buildTableFilterConfigs } = await import('../../../../../../src/public/js/plugins/datatable/utils/filters/tableFilterConfigs.js');
